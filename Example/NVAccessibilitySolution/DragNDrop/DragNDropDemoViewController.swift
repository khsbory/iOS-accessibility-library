...
class DragNDropDemoViewController: UIViewController {
...
//                }
    ...
    func initLongPressGesture() {
        ...
        let storyBoard: UIStoryboard = UIStoryboard(name: "DragNDrop", bundle: nil)
        popup = storyBoard.instantiateViewController(withIdentifier: "DragNDropPopup") as? DragNDropPopup
...
extension DragNDropDemoViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "DragNDropTableViewCell", for: indexPath) as! DragNDropTableViewCell
...
//        action.title = title
        ...
        // title 대신 image 삽입
        _ = self.selectNumberArray.exists(number) ? "check" : "uncheck"
        
        return action
    }
    
}
extension DragNDropDemoViewController: DragNDropDelegate {
    func showMorePopup(number: Int) {
        self.showPopup()
    }
