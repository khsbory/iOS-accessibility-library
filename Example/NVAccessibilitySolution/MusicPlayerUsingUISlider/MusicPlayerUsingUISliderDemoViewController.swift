//
//  MusicPlayerUsingUISliderDemoViewController.swift
...
class MusicPlayerUsingUISliderDemoViewController: UIViewController {
    ...
    @IBAction func dragging(_ sender: UISlider) {
        ...
        if timeSlider.isAccessibilityFocusStarted && Commons.isAccessibilityApplied {
